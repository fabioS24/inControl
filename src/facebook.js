...
chrome.storage.sync.get(['start_study', 'version'], function(result) {
    ...
    studyWeek = getStudyWeek(startStudy);
    //testVersion = 2;
    //studyWeek = 2;
...
let initializeHome = () => {
    ...
    if(center[0] != undefined) {
        ...
        if(secondSection) {
            ...
            console.log("Figli classe postForm: " + $(".rq0escxv.l9j0dhe7.du4w35lb.hybvsw6c.io0zqebd.m5lcvass.fbipl8qg.nwvqtn77.k4urcfbm.ni8dbmo4.stjgntxs.sbcfpzgs").length);
            console.log($(".rq0escxv.l9j0dhe7.du4w35lb.hybvsw6c.io0zqebd.m5lcvass.fbipl8qg.nwvqtn77.k4urcfbm.ni8dbmo4.stjgntxs.sbcfpzgs"));
            if($(".rq0escxv.l9j0dhe7.du4w35lb.hybvsw6c.io0zqebd.m5lcvass.fbipl8qg.nwvqtn77.k4urcfbm.ni8dbmo4.stjgntxs.sbcfpzgs").length > 5) {
    ...
    buttonsGroup.innerHTML = `<div class="homeSquare" onclick="location.href='/friends';" style="cursor: pointer;">
    ...
    <h3 class="FBbuttonsText">Friends</h3>
    </div>
    <div class="homeSquare" onclick="location.href='/groups/feed/';" style="cursor: pointer;">
    ...
    <h3 class="FBbuttonsText">Groups</h3>
    </div>
    <div class="homeSquare" onclick="location.href='/watch';" style="cursor: pointer;">
    ...
    <h3 class="FBbuttonsText">Watch</h3>
    </div>`;
...
function checkURLchange(currentURL){
    if(currentURL != oldURL){
        ...
        chrome.storage.sync.get({
            ...
            //items.version = 2;
            //console.log("Version: " + items.version + " --- Study week: " + studyWeek);
            if(currentURL === "https://www.facebook.com/" /*&& items.FBhome*/) {
                if((studyWeek == 1 && items.version == 1) || (studyWeek == 2 && items.version == 2)) {
